    ...
    try {
        ...
        const commands: Record<string, { name: string; value: string }[]> = {
            "about": [
                ...
                { name: "🚀 Custom Structure Example", value: `\`${prefix} ga custom Mythic GA 1h 3 --role VIP --extraentries --field "Requirement: Level 100+"\`` },
                { name: "🚀 Basic Structure Example", value: `\`${prefix} ga create Mythic GA 1h 3 --role VIP\`` },
            ...
            "basic": [
                { name: "🚀 Basic Structure Example", value: `\`${prefix} ga create Mythic GA 20s 3 --role VIP\`` },
